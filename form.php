...
<body>
  ...
  <p class="search-result"><?php echo $prefectures[$pref];
    echo('の観光スポットは'.$count.'件見つかりました。');
    ?></p>
    <div class="media">
      <div class="media-left">
     <?php foreach($places[$pref] as $place => $reviews){
      echo ('<img src="'.$reviews['image'].'" class="media-object img-thumbnail">');
        }?>
      </div>
      <div name="pref" class="media-body">
      <?php
